...
**Sistema:** Particles themselves, their fixed or unfixed barriers, the increase in light output and the camera movement.

**Instrumento:** Doesn't seem to be one. The system reacts to specific changes in the amplitude and frequency of the song. At least it appears that way.

**Interpreta:** If it is intentional manipulation by an operator, the changes in camera rotation and speed, as well as the colors of the orbs themselves.
...
**Sistema:** Compute shader, similar al del proyecto base.

**Instrumento:** Unclear, no exposed controls are visible.

**Interpreta:** Camera movement, particle density, color changes.

**Emerge:** The distinctive shapes crafted by manipulation or coding.
